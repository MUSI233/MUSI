...
<head>
    ...
    <![endif]-->
    <script>
        var _hmt=_hmt||[];(function(){var hm=document.createElement("script");hm.src="https://hm.baidu.com/hm.js?2d70358a902c57eec3d87e96cf015b47";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(hm,s)})();
    </script>
    <style>
        ...
        <div id="sidebar">
            <div id="sidebar-brand" class="themed-background">
                <a href="./" class="sidebar-title">
                    <i class="fa fa-cube"></i> <span class="sidebar-nav-mini-hide"><?php echo $allow_domain_auth_title; ?>系统管理后台</span>
                </a>
            </div>
            <div id="sidebar-scroll">
                <div class="sidebar-content">
                    <ul class="sidebar-nav">
                        ...
                        plugin\AdminMenu::addMenu('自定义访问URL对接日志','./diyurl.php','diyurl','','对接设置');
                        ...
                        plugin\AdminMenu::addMenu('余额充值配置','./set.php?mod=recharge','recharge','','系统设置');
                        ...
                        plugin\AdminMenu::addMenu('拓展插件','','','fa fa-cogs');
                        plugin\AdminMenu::addMenu('每日签到设置','./set.php?mod=qiandao','qiandao','','拓展插件');
                        plugin\AdminMenu::addMenu('推广链接设置','./invite.php','invite','','拓展插件');
                        plugin\AdminMenu::addMenu('抽奖商品设置','./choujiang.php','choujiang','','拓展插件');
                        plugin\AdminMenu::addMenu('订单管理设置','./order_set.php','order_set','','拓展插件');
                        plugin\AdminMenu::addMenu('分类-支付禁用开关设置','./pay_switch.php','pay_switch','','拓展插件');
                        plugin\AdminMenu::addMenu('防红接口设置','./set.php?mod=dwz','dwz','','拓展插件');
                        plugin\AdminMenu::addMenu('安全检查','./safe_check.php','safe_check','','拓展插件');
                        plugin\AdminMenu::addMenu('数据统计','./statistic.php','statistic','','拓展插件');

                        plugin\AdminMenu::addMenu('文章管理','','','fa fa-list-alt');
                        plugin\AdminMenu::addMenu('添加文章','./Article.php?mod=ArticleAdd','ArticleAdd,ArticleUpdate','','文章管理');
                        plugin\AdminMenu::addMenu('文章列表','./Article.php?mod=ArticleList','ArticleList','','文章管理');

                        plugin\AdminMenu::addMenu('内链建设','','','fa fa-list-alt');
                        plugin\AdminMenu::addMenu('内链列表','./Keywords.php?mod=keywordsList','KeywordsList','','内链建设');
                        plugin\AdminMenu::addMenu('内链添加','./Keywords.php?mod=keywordsAdd','KeywordsAdd','','内链建设');


					    plugin\AdminMenu::addMenu('栏目SEO','','','fa fa-list-alt');
                        plugin\AdminMenu::addMenu('SEO列表','./Cate.php?mod=cateList','cateList','','栏目SEO');
                        plugin\AdminMenu::addMenu('SEO添加','./Cate.php?mod=cateAdd','cateAdd','','栏目SEO');
                        ...
                        plugin\AdminMenu::addMenu('应用市场','','','fa fa-puzzle-piece');
                        plugin\AdminMenu::addMenu('首页模板设置','./set.php?mod=template','template','','应用市场');
                        plugin\AdminMenu::addMenu('插件管理','./plugin.php','plugin','','应用市场');
                        plugin\AdminMenu::addMenu('钩子管理','./hook.php','hook','','应用市场');

                        plugin\AdminMenu::addMenu('安全中心', './webSafe.php', 'webSafe', 'fa fa-shield');
...
//                        hook('renderAdminMenu',[]);
            ...
            <div id="sidebar-extra-info" class="sidebar-content sidebar-nav-mini-hide">
                ...
                <div class="text-center">
                    ...
                    <?php if (!empty($allow_domain_auth_copyright)): ?>
                    <br>
                    <small><?php echo $allow_domain_auth_copyright; ?></small>
                    <?php endif; ?>
                </div>
            </div>
        </div>
